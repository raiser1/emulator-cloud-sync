...
## Status: tracked as a Station project

As of 2026-08-08 the open items above (§F, §H, §I, the ROM-library decision, and the Legal/Divorce
folder placement) are tracked as Station tickets rather than left as prose in this doc — see
`raiser1/station` → `station/tickets/STN-0016.md` through `STN-0021.md`. Those tickets are the
system of record for status; this file remains the detailed technical reference they point back to.
